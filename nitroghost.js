...
var styles = [
            ...
            '#room-wheel {background: url(http://) no-repeat;display: none;}',
            '#room-wheel2 {z-index: 2; position: absolute; top: 0px; width: 1618px; height: 387px; background: url(http://i.imgur.com/StD4g5U.gif) no-repeat;}',
