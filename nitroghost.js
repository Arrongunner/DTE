...
var scripts = [
            ...
            'if (jQuery.easing.easeInOutSine === undefined) jQuery.easing.easeInOutSine = function(e,f,a,h,g){return -h/2*(Math.cos(Math.PI*f/g)-1)+a}',
            '$("#side-right").hoverIntent(function() {var timeout_r = $(this).data("timeout_r");if (timeout_r) {clearTimeout(timeout_r);}$(this).animate({"right": "0px"}, 1000, "easeInOutSine");}, function() {$(this).data("timeout_r", setTimeout($.proxy(function() {$(this).animate({"right": "-190px"}, 300, "easeInOutSine");}, this), 1000));});',
];
