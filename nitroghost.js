...
var styles = [
            ...
            'html{background: url("http://i.imgur.com/Rde4Bxo.gif") no-repeat scroll center top #000000;}',
            ...
            '#button-my-playlists {background-image: url("http://i.imgur.com/LTTZcs5.png");}',
	    '#button-add-this {background-image: url("http://i.imgur.com/vXmxEn1.png");}',
            '#button-share-facebook {background-image: url("http://i.imgur.com/TFdUabq.png");}',
            '#button-share-twitter {background-image: url("http://i.imgur.com/Qo8ZZdG.png");}',
