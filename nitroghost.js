...
function onCookiesLoaded() {
	...
	if (left) {
		$(".sidebar#side-left").animate({"left": left ? "0px" : "-190px"}, 250, "easeOutCirc");
	}
    	initAPIListeners();
    	displayUI();
    	initUIListeners();
...
var scripts = [
            ...
            '$("#side-right").hoverIntent(function() {var timeout_r = $(this).data("timeout_r");if (timeout_r) {clearTimeout(timeout_r);}$(this).animate({"right": "0px"}, 250, "easeOutCirc");}, function() {$(this).data("timeout_r", setTimeout($.proxy(function() {$(this).animate({"right": "-190px"}, 250, "easeOutCirc");}, this), 500));});',
];
