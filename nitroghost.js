function delay() {
	...
	setTimeout("Main.onWindowResize = function (a){this.LEFT=Math.max(0,($(window).width()-this.WIDTH)/2);$("body").css("background-position",($(window).width()-1920)/2+"px 0");var b=$("#meta-frame");b.css("left",this.LEFT);b=$("#playback");b.css("left",this.LEFT+353);b=$("#footer-container");b.css("left",this.LEFT+this.WIDTH-b.width());var b=$("#chat"),c=this.LEFT+this.WIDTH-b.width();b.css("left",c);b=$("#chat-mention-suggestion");b.css("left",c);b=$("#room-wheel");b.css("left",this.LEFT);b=$("#audience");b.css("left",this.LEFT);b=b.offset();b.left-=15;RoomUser.audience.offset=b;if(b=$("#dj-booth"))b.css("left",this.LEFT),RoomUser.djBooth.offset=b.offset();b=$("#user-container");b.css("left",this.LEFT+this.WIDTH-b.width());b=$("#media-overlay");b.css("left",this.LEFT+(this.WIDTH-b.width())/2);b.css("top",(687-b.height())/2);b=$("#avatar-overlay");b.css("left",this.LEFT+(this.WIDTH-b.width())/2);b.css("top",(687-b.height())/2);b=$("#lobby-overlay");b.css("left",this.LEFT+(this.WIDTH-b.width())/2);b.css("top",(687-b.height())/2);b=$("#user-list-overlay");b.css("left",this.LEFT+(this.WIDTH-b.width())/2);b=$(".modal-background");b.css("width",Math.max(1200,$(window).width()));b.css("height",Math.max(746,$(window).height()));b=$(".dialog");b.css("left",this.LEFT+(this.WIDTH-b.width())/2);b.css("top",(687-b.height())/2);if(EXT&&EXT.onWindowResize)EXT.onWindowResize(a)}", 6000);
}
...
overPlayed = ["1:LQtZ0ZsTW8c", "1:8cOt9UcYGOU", "1:LXO-jKksQkM", "1:4wTLjEqj5Xk", "1:sf6LD2B_kDQ", "1:F2FMDV8yW9M", "1:4q-jv4OBCa0", "1:-0oZNWif_jk", "1:vZyenjZseXA", "1:ZT4yoZNy90s", "1:Bparw9Jo3dk", "1:KrVC5dm5fFc","1:Ys9sIqv42lo", "1:1y6smkh6c-0", "1:jZL-RUZUoGY", "1:CrdoD9T1Heg", "1:6R_Rn1iP82I", "1:ea9tluQ_QtE", "1:f9EM8T5K6d8", "1:aHjpOzsQ9YI", "1:3vC5TsSyNjU", "1:yXLL46xkdlY", "1:_t2TzJOyops", "1:BGpzGu9Yp6Y", "1:YJVmu6yttiw", "1:WSeNSzJ2-Jw", "1:2cXDgFwE13g", "1:PR_u9rvFKzE", "1:i1BDGqIfm8U"];
