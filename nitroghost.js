...
function sts(secs) {
	...
	if (nohrs > 0) {
		if (nomins > 9 && nosecs > 9) {
			return nohrs + ":" + nomins + ":" + nosecs
		} 
		else (nomins < 9 && nosecs < 9) {
			return nohrs + ":0" + nomins + ":0" + nosecs
		}
		else (nomins < 9 && nosecs > 9) {
			return nohrs + ":0" + nomins + ":" + nosecs			
		}
		else (nomins > 9 && nosecs < 9) {
			return nohrs + ":" + nomins + ":0" + nosecs
		}
	} 
	else {
		if (nomins > 1) {
