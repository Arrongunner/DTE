...
var customisedChatsModel = Class.extend({
    init: function(){
        ChatModel.chatCommand = function (a) {
            ...
            if ("/commands" == a) API.getMedia ().id}; return log("/ca = change avatar, /op = overplayed");
            if ("/ca" == a)  API.getMedia ().id}; return Models.user.changeAvatar(prompt("enter avatar code"));
