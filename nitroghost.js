...
var styles = [
            ...
            '#room-wheel {z-index: 2;position: absolute;top: 0px; width: 1618px;height: 387px;background: url(http://i.imgur.com/StD4g5U.gif) no-repeat;display: none;}',
...
$('body').prepend('<style type="text/css" id="plug-css">' + "\n" + styles.join("\n") + "\n" + '</style>' + '<div id="room-wheel" style="display: block; left: 8px;"></div>');
