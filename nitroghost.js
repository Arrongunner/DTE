...
var styles = [
            ...
            '#map-canvas {background-image: url(http://) ;}',
            '#audience {background-image: url(http://) ;}',
            ...
            '#dj-console, #dj-console {background-image: url(http://i.imgur.com/lUtxF7D.gif);min-height:33px;min-width:131px;}',
